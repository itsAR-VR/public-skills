...
description: "Deprecated upstream alias (ECC v1.8.0): the canonical loop skill is ecc-continuous-agent-loop. Retained one release for compatibility; author new loop guidance in ecc-continuous-agent-loop."
origin: ECC
---
