...
Source check (2026-06-10): Soul CLI commands, plan gates, model IDs, and quality tiers are operational guidance. Before depending on them, refresh with `higgsfield soul-id --help`, `higgsfield model list --json`, and `higgsfield model get <job_set_type> --json`; update this skill if CLI output disagrees.
