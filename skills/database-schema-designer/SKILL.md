...
license: MIT
related_skills: [database-design, backend-development, backend-coding-agent, backend-to-frontend-handoff-docs, frontend-to-backend-requirements]
---
...
- For a full deployment review, load `references/schema-design-checklist.md`.
