...
metadata:
  version: 1.0.0
related_skills: [hormozi-retention, referral-program, ecom-lifecycle-flows, onboarding-cro, email-sequence]
---
...
For implementation, use the relevant billing, analytics, and lifecycle tooling below.
