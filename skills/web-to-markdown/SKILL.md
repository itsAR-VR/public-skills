...
metadata:
  version: 0.1.0
related_skills: [perplexity, ecc-documentation-lookup, lastXdays, x-thread-fetcher, knowledge-base]
---
...
- Do not use Browser Harness or other browser automation stacks; the mechanism is `web2md`.
