...
related_skills: [humanizer, writers-studio, copy-editing, professional-communication, crafting-effective-readmes]
---
...
For memos, founder notes, client updates, or public posts that still feel
AI-shaped after a clarity pass, run `hormozi-humanizer`. Use it to recover the
plain-English point before polishing sentences.
...
Writing for humans? Load the relevant section from `elements-of-style/` and apply the rules. For most tasks, `elements-of-style/03-elementary-principles-of-composition.md` covers what matters most.
