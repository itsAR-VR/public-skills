...
- Device/OS/Xcode-Instruments version/build configuration.
...
Load these summaries only when their specific Instruments or SwiftUI concept is needed. Refresh them when Apple renames SwiftUI Instruments lanes/templates or Observation APIs such as `@Observable`.
