...
# -*- coding: utf-8 -*-
"""
Icon Generation Script using the configured Gemini text model.
Generates SVG icons via text generation (SVG is XML text format)

Model source check: local default reviewed 2026-06-10; verify current Google
Gemini API model docs before treating the model ID, limits, or availability as
...
MODEL = "gemini-3.1-pro-preview"  # Local default reviewed 2026-06-10
...
def generate_icon(prompt, style=None, category=None, name=None,
    ...
    """Generate a single SVG icon using the configured Gemini text model."""
...
def main():
    parser = argparse.ArgumentParser(
        description="Generate SVG icons using the configured Gemini text model"
    )
