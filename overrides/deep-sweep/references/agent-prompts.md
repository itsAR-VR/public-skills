...
provider-appropriate high effort or adaptive reasoning when the active provider
supports it. Do not expose hidden/internal reasoning; return evidence-backed
findings, assumptions, and confidence only.
...
Analyze this problem deeply using provider-appropriate depth. Consider:
