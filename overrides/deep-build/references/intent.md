...
- In Claude Code, refresh `references/model-currency.md` before pinning; prefer a currently supported Claude alias and record any pinned fallback in run evidence
