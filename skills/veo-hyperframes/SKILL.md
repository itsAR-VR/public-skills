...
metadata:
  ...
  source_file: skill-veo-hyperframes.json
  hyperagent_name: "Veo + Hyperframes"
  exported_at: "2026-05-28T16:58:18.555Z"
  auth_type: "none"
  tags:
    - "video"
    - "veo"
    ...
    - "storyboard"
  when_to_use: >-
    Use when producing any video that combines AI-generated footage (Veo) with motion
    graphics text overlays (Hyperframes). The core discipline is Text Zone Composition:
    every shot must reserve a clear 1/3 of the frame with deliberate contrast for legible
    text. Applies to product launch videos, brand hype reels, social clips, and any
    multi-beat video where text must be legible over generated footage.
---
# Veo + Hyperframes
