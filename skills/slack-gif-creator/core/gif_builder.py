...
class GIFBuilder:
    ...
    def save(self, output_path: str | Path, num_colors: int = 128,
        ...
        Args:
            ...
            optimize_for_emoji: If True, optimize for <128KB emoji size
        ...
        # Warnings
        if optimize_for_emoji and file_size_kb > 128:
            print(f"\n⚠️  WARNING: Emoji file size ({file_size_kb:.1f} KB) exceeds 128 KB target")
