...
description: >-
  ...
  points a landscaping company needs to run it in production.
metadata:
  source_repo: https://github.com/alexmcdonnell-airtable/hyperagent-public-skills
  source_commit: a1349c1
  source_file: skill-landscaping-design-and-quote.json
  hyperagent_name: "Landscaping design and quote"
  exported_at: "2026-06-08T14:01:12.900Z"
  auth_type: "none"
  tags:
    - "landscaping"
    - "quote"
    ...
    - "home-services"
  when_to_use: >-
    When building a customer-facing landscaping (or any exterior/renovation) design + quote
    deliverable from a submitted photo and an address — proposals, lead-response packages,
    before/after pitch tools, or sizzle demos of an estimating agent. Also the reference for
    the "switch between N design styles on the same yard" hero and the live-recalculating
    quote builder.
---
