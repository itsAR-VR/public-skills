...
**Source freshness:** Last source check: 2026-06-10. Treat all provider names,
model IDs, prices, API availability, output limits, latency, and feature claims
in this reference as volatile. Before production use, verify exact values against
the linked official vendor docs and refresh this reference if vendor docs differ,
a model is released/deprecated, or a cost estimate is used in a client-facing
deliverable.
...
**Pricing:** Varies by model speed, audio, resolution, and cloud surface; check
the linked Google pricing docs before estimating.
...
**API:** OpenAI API
**Pricing:** Varies by model, resolution, duration, and API surface; check
OpenAI's current pricing docs before estimating.
...
**Pricing:** Check OpenAI's current pricing docs before estimating; speech
pricing has moved across character-, token-, and audio-based meters.

**Capabilities:**
- 11 built-in voices (no custom cloning)
- Multiple languages
- Real-time streaming
- HD quality option
...
| 100 × 15-sec videos | Veo 3.1 Fast | Check current Google pricing by audio/resolution |
