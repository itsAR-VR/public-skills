...
Source check: verified against Apple Developer documentation on 2026-06-11; refresh this guide when Apple changes the Liquid Glass docs, SwiftUI symbol names, or the target iOS SDK.
