...
Before recommending implementation tooling, verify the user's current stack and current vendor docs. Key RevOps tools:

| Tool | What It Does | Guide |
|------|-------------|-------|
| **HubSpot** | CRM, marketing automation, lead scoring, workflows | Verify current HubSpot docs |
| **Salesforce** | Enterprise CRM, pipeline management, reporting | Verify current Salesforce docs |
| **Calendly** | Meeting scheduling, round-robin routing | Verify current Calendly docs |
| **SavvyCal** | Scheduling with priority-based availability | Verify current SavvyCal docs |
| **Clearbit** | Real-time lead enrichment and scoring | Verify current Clearbit docs |
| **Apollo** | Contact data, enrichment, and outbound sequences | Verify current Apollo docs |
| **ActiveCampaign** | Marketing automation for SMBs, lead scoring | Verify current ActiveCampaign docs |
| **Zapier** | Cross-tool automation and workflow glue | Verify current Zapier docs |
| **Introw** | Partner-sourced pipeline, commissions, deal registration, QBRs | Verify current Introw docs |
| **Crossbeam** | Partner account overlaps and co-sell identification | Verify current Crossbeam docs |
