...
Before implementation, verify which ad-platform tools or connectors are
available in the current environment. For platform setup, use
[platform-setup-checklists.md](references/platform-setup-checklists.md). For
tracking, use [conversion-tracking.md](references/conversion-tracking.md).
