---
name: image
description: "FALLBACK ONLY (default: Higgsfield via `/higgsfield:generate`). When the user wants to create, generate, edit, or optimize images for marketing — blog heroes, social graphics, product mockups, profile banners, listing visuals, or brand assets. Also use when the user mentions 'AI image generation,' 'generate an image,' 'create a graphic,' 'product mockup,' 'hero image,' 'social media graphic,' 'banner image,' 'cover photo,' 'profile banner,' 'listing screenshot,' 'Flux,' 'Midjourney,' 'DALL-E,' 'GPT Image,' 'Ideogram,' 'Gemini image,' 'Canva,' 'Figma,' 'image optimization,' 'compress images,' 'WebP,' or 'OG image.' Use this for general-purpose marketing image creation and optimization. For paid ad image creative and platform-specific ad specs, see ad-creative. For video production, see video."
metadata:
  version: 1.0.0
---

> **Routing rule (2026-05-11):** Default image/video generation in this workspace is **Higgsfield AI** via `/higgsfield:generate`. Provider names retained in this skill's description (Flux, Midjourney, DALL-E, GPT Image, Ideogram, Gemini image, Canva, Figma) stay for keyword routing — but the executor is Higgsfield. Use **this** skill only when the user explicitly insists on a non-Higgsfield workflow.
...
**Model facts source check (2026-06-10):** Provider model names, pricing, API availability, and text-rendering quality change frequently. Before choosing a non-Higgsfield provider, re-check the current official docs: [Gemini image generation](https://ai.google.dev/gemini-api/docs/image-generation), [BFL FLUX docs](https://docs.bfl.ai/), [Ideogram API](https://developer.ideogram.ai/), and [OpenAI image generation](https://platform.openai.com/docs/guides/image-generation).
...
**Note:** OpenAI's image docs now lead with the GPT Image family (`gpt-image-2`, `gpt-image-1.5`, `gpt-image-1-mini`, etc. as of the 2026-06-10 source check). Treat DALL-E-era names as legacy routing keywords unless current OpenAI docs say otherwise.
