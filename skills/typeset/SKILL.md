...
Consult the [typeset reference](../impeccable/reference/typeset.md) from the impeccable skill for detailed guidance on scales, pairing, and loading strategies.
