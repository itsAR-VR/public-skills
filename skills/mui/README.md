...
**Source check (2026-06-10)**: Official MUI docs currently show Material UI v9.1.0. Use this skill for MUI v7 codebases or v7 maintenance, and check the official MUI migration docs before applying version-specific guidance to newer projects.
