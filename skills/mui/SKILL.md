...
related_skills: [react-dev, ecc-frontend-design, design-system-starter, premium-ui-components, ui-skills]
---
...
**Source check (2026-06-10)**: Official MUI docs currently show Material UI v9.1.0. Use this skill for codebases pinned to MUI v7 or maintaining v7-era patterns; check the official MUI migration docs before applying version-specific guidance to newer projects.

**Note**: MUI v7 breaking changes from v6:
- Private/internal deep imports are unsafe - use public package exports and documented import paths
