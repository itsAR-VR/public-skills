...
name: memorybench
description: >
  Benchmark a custom memory implementation against systems like Supermemory,
  Mem0, and Zep with guided setup and automated comparisons.
metadata:
  author: OpenDirectory
  version: 1.0.0
related_skills: [supermemory, memory-systems]
---
