...
- Exports a print-ready PDF via Browser Harness (A4 portrait, 1200×1697px)
...
- `scripts/export-pdf.sh` — PDF export via Browser Harness (auto-installs Browser Harness + Chromium on first run)
