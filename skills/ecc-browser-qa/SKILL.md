...
Uses the browser automation MCP (claude-in-chrome, Browser Harness, or Puppeteer) to interact with live pages like a real user.
...
- Browser Harness via `mcp__browserbase__*`
