...
related_skills: [ecc-frontend-design, frontend-coding-agent, canvas-design, design-system-starter, impeccable]
---
...
A capable agent can optimize tool descriptions. When given a tool and observed failure modes, it diagnoses issues and suggests improvements. In the cited production testing, this approach achieved 40% reduction in task completion time by helping future agents avoid mistakes.
