...
description: >-
  ...
  successor to the earlier 'Brand Concept Generator'.)
metadata:
  source_repo: https://github.com/alexmcdonnell-airtable/hyperagent-public-skills
  source_commit: a1349c1
  source_file: skill-brand-book-generator.json
  hyperagent_name: "Brand Book Generator"
  exported_at: "2026-06-01T14:07:10.559Z"
  auth_type: "none"
  tags:
    - "branding"
    - "design"
    ...
    - "2026-trends"
  when_to_use: >-
    Use when a founder has an app/product and wants an agency-grade brand identity they can
    SEE in one screen across several bold directions. Triggers: "build a brand for my app",
    "brand kit/brand book", "brand concepts", "show me a few directions", "make it look like
    an agency did it". Needs only app name + one-line description; optionally audience,
    positioning, founder photos. Prefer this over the older 'Brand Concept Generator' — this
    is the single-screen, no-scroll version.
---
...
### 4. Build from `assets/brandbook_template.html` (this skill's template)
