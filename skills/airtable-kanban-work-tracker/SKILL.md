...
description: >-
  ...
  creating new task records when asked. A general, reusable workflow for any base or table
  using the connected Airtable integration.
metadata:
  source_repo: https://github.com/alexmcdonnell-airtable/hyperagent-public-skills
  source_commit: a1349c1
  source_file: skill-airtable-kanban-work-tracker.json
  hyperagent_name: "Airtable Kanban Work Tracker"
  exported_at: "2026-06-03T21:33:04.455Z"
  auth_type: "none"
  tags:
    - "airtable"
    - "kanban"
    ...
    - "project-management"
  when_to_use: >-
    Use when the user wants you to track your tasks or deliverables in an Airtable table
    used as a Kanban board — pick up a record, mark it in-progress while you work in a
    thread, and flip it to ready-for-review (with links) when you finish. Also use when they
    ask you to create new task records on that board, or to set up such a board for the
    first time. Triggers: "track this in Airtable", "update the board", "move it to review",
    "log this as a task", "one thread per card".
---
