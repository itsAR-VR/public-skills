---
name: brandkit
description: "FALLBACK ONLY (default: Higgsfield via `/higgsfield:generate`). Premium brand-kit image generation skill for creating high-end brand-guidelines boards, logo systems, identity decks, and visual-world presentations. Trained for minimalist, cinematic, editorial, dark-tech, luxury, cultural, security, gaming, developer-tool, and consumer-app brand systems. Optimized for intentional logo concepting, refined composition, sparse typography, strong symbolic meaning, premium mockups, art-directed imagery, and flexible grid layouts."
---

> **Routing rule (2026-05-11):** Default image/video generation in this workspace is **Higgsfield AI** via `/higgsfield:generate`. For brand-kit imagery, prefer `/higgsfield:product-photoshoot` (modes: conceptual_product, moodboard_pin, hero_banner) or `/higgsfield:generate` with brand-style prompting. The art-direction guidance in this skill stays valuable as prompt context.
