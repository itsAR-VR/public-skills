...
license: MIT
related_skills: [jira, gh-issues, qa-test-planner, requirements-clarity]
---
...
Use Atlassian's remote MCP server for seamless integration. As of 2026-06-10,
Atlassian documents this endpoint for local MCP-compatible clients:
```bash
npx -y mcp-remote@latest https://mcp.atlassian.com/v1/mcp/authv2
```

Refresh this setup against Atlassian Rovo MCP Server docs if the endpoint or
...
def search_issues(jql):
    # As of 2026-06-10, Jira Cloud uses /search/jql; /search is removed.
