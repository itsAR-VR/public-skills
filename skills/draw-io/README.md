...
Uses the bundled `mxgraph.aws4.*` icon IDs; check current AWS Architecture Icons before adding a newly released service.
...
- Official AWS service names and checked icon IDs
...
- [ ] AWS icons use `mxgraph.aws4.*`; newly released services were checked against current AWS Architecture Icons
