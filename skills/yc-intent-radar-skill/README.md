...
> **Note**: the implementation lives in the canonical `yc-jobs-scraper` skill. This skill exists as a higher-level "intent radar" wrapper concept; setup and usage commands below run inside `skills/yc-jobs-scraper/scripts/`.

## Setup
1. Clone the repository.
2. Navigate to the canonical scraper's `scripts/` directory:
   ```bash
