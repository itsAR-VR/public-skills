...
description: Read the current branch diff and write a complete GitHub pull request description, then create or update the PR with `gh`. Enforces an active-voice, no-fluff style with specifics over generalities.
compatibility:
- claude-code
- gemini-cli
- github-copilot
