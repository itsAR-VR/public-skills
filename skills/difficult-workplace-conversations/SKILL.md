...
description: >
  Prepare and structure difficult workplace conversations about conflict,
  performance issues, critical feedback, compensation, promotion, termination,
  emotional reactions, or sensitive team dynamics using the
  preparation-delivery-followup framework. Use when you need conversation
  goals, SBI-style facts, opening language, resolution steps, escalation
  criteria, or follow-up agreements for a manager, peer, teammate, or report.
allowed-tools: Read, Glob, Grep
related_skills: [feedback-mastery, professional-communication, internal-comms]
---
