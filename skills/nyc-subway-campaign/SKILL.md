...
description: >-
  ...
  subway placements with GPT Image 2, and assemble an agency-grade single-page case study.
  Use when someone wants to mock up / pitch / visualize a brand's subway campaign.
metadata:
  source_repo: https://github.com/alexmcdonnell-airtable/hyperagent-public-skills
  source_commit: a1349c1
  source_file: skill-nyc-subway-campaign.json
  hyperagent_name: "NYC Subway Campaign"
  exported_at: "2026-06-08T14:03:40.760Z"
  auth_type: "none"
  tags:
    - "design"
    - "branding"
    ...
    - "webpage"
  when_to_use: >-
    When the user wants to visualize, mock up, pitch, or art-direct a NYC subway (or transit
    OOH) advertising campaign for a brand — real or fictional — and wants a cohesive
    agency-grade deliverable (brand identity + ads rendered in real subway settings + a
    webpage). Also a strong reference for any transit/OOH campaign visualization where
    brand-mark consistency across many generated images matters.
---
...
Use `assets/campaign_page_template.html` (bundled with this skill). It's the genericized version of the validated Brightleaf page. Edit only:
...
7. Fill `assets/campaign_page_template.html`; PublishWebpage; return the placeholder.
