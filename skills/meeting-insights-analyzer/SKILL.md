...
related_skills: [daily-meeting-update, internal-comms, professional-communication, feedback-mastery]
---
...
- Export transcripts using Granola's current export/share flow, or copy the transcript text into local files
