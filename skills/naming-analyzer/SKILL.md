...
description: Analyze variable, function, class, file, API, and schema names; use when auditing naming clarity, conventions, misleading identifiers, booleans, abbreviations, or refactor-safe rename suggestions.
related_skills: [audit-lexical-ontology, audit-module-stutter, audit-semantic-noise, code-review, audit-inline-complexity]
---
...
**Evidence**: Name should reflect the mutation
...
**Evidence**: Specific names improve clarity
...
**Evidence**: Clarity and searchability
...
**Evidence**: Full words are more readable
...
**Evidence**: Follow boolean naming convention
...
**Evidence**: Specific purpose is clearer
...
**Evidence**: Consistency in convention
