...
These local integration guides no longer exist in this repo. Before implementing
against a CMS API, verify the current official docs:

- [Sanity docs](https://www.sanity.io/docs) — GROQ queries, mutations, CLI
- [Contentful developer docs](https://www.contentful.com/developers/docs/) — Delivery/Management APIs, publishing
- [Strapi docs](https://docs.strapi.io/) — REST CRUD, filters, document API
