...
description: >
  ...
  changing behavior. Use when the user asks to refactor code, clean up legacy
  code, reduce complexity, improve maintainability, or says "this code is messy,"
  "simplify this," or "extract this into a function." For reviewing code changes,
  see code-review.
related_skills: [code-review, code-documentation, commit-work, backend-development, backend-coding-agent, frontend-coding-agent]
metadata:
  author: wshobson
  version: 1.1.0
