...
- Use official `mxgraph.aws4.*` icons; check current AWS Architecture Icons before adding a newly released service
...
- [ ] AWS icons use `mxgraph.aws4.*` and newly released services were checked against current AWS Architecture Icons
