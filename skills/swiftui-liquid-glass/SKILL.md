...
- Source check: API details verified against Apple Developer documentation on 2026-06-11; refresh when Apple changes the Liquid Glass docs or the target iOS SDK.
