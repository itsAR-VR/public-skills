...
related_skills: [meme-factory, image-enhancer]
---
...
Source check: As of 2026-06-11, Slack's custom emoji help recommends square
images under 128KB and says GIFs can include up to 50 frames. Recheck Slack's
official help before changing these limits.
...
**Emoji GIFs:**
- Max size: 128KB target
- Optimal dimensions: 128x128
- Typical FPS: 10-12
- Color limit: 32-48
- Duration: 1-2s

**Emoji GIFs are challenging** - the 128KB target is tight. Strategies that help:
...
**For Emoji GIFs (>128KB) - be aggressive:**
